...
def test_process_event_history() -> None:
    """Test method process_event_history of application.py with given
     dictionary.MY THINGGGGGGGGG.
     """
    process_event_history(test_dict, [Customer(test_dict['customers'][0]['id'])])
    for customers in [Customer(test_dict['customers'][0]['id'])]:
        print(customers.get_history())
