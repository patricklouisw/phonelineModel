...
def test_events2() -> None:
    ...
    assert bill[0] == 5555
    # assert bill[1] == pytest.approx(70)
    assert bill[2][0]['total'] == pytest.approx(20)
    assert bill[2][0]['free_mins'] == 0
    assert bill[2][1]['total'] == pytest.approx(50)
    assert bill[2][1]['billed_mins'] == 0
    assert bill[2][2]['total'] == pytest.approx(- 24.95)
...
def test_events() -> None:
    ...
    assert bill[2][2]['total'] == pytest.approx(0.025)
    assert bill[2][2]['billed_mins'] == 100
